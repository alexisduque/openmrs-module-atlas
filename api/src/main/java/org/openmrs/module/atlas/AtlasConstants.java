...
public class AtlasConstants {
	...
	public final static String SERVER_PING_URL = "https://atlas-stg.openmrs.org/module/ping.php";
    
    public final static String SERVER_URL = "https://atlas-stg.openmrs.org/module";
}
