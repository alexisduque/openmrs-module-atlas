...
<script type="text/javascript">
    ...
    function updateModulefromServer() {
        connected = isModuleConnect("https://atlas.local/module/auth?uuid=${data.id}&callback=getAuth");
    }
...
<body>
    <div id="home">
        <iframe src="https://atlas.local/module?uuid=${data.id}&patients=${data.numberOfPatients}&encounters=
